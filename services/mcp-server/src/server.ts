...
function asTextContent(name: string, data: unknown, note?: string) {
  return {
    content: [
      {
        type: 'text' as const,
...
export function createServer(client: PlatformClient) {
